...
credentials = service_account.Credentials.from_service_account_file("policy.json")
...
async def get_list_frames(
    video: str = Path(..., description="Video list of frames")
) -> JSONResponse:
    ...
    return JSONResponse(status_code=status.HTTP_200_OK, content={"list_frames": list_keyframes})
