...
def get_args(description="CLIP2Video on Dideo-Text Retrieval Task"):
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="frame rate for uniformly sampling the video",
    )
    parser.add_argument(
        "--output_dir",
        default=None,
    ...
    parser.add_argument(
        ...
        default=0,
        type=int,
        help="shard_id: node rank for distributed training",
    )
    parser.add_argument(
        "--datatype",
        default="msrvtt",
        type=str,
        help="msvd | msrvtt | vatexEnglish | msrvttfull",
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.5,
        help="the weight to adopt the main simiarility",
    )
